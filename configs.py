...
class Config(object):
    API_ID = int(os.getenv("API_ID", "27324006"))
    API_HASH = os.getenv("API_HASH", "9cf7c25b49c01106ad13d784f69c100a")
...
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "cyniteSupport")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "ckmovieshub")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "ckmovieshub")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "gAgo70Xw7Ztq9zqqW4Px")
...
https://teraboxapp.com/s/1mfr6fYFUH94v6TTtFXGM2w
